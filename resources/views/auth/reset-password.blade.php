                ...
                <div
                    ...
                    <div class="mx-auto w-full max-w-[440px]">
                        <div class="mb-10">
                            ...
                            <p class="text-base font-bold leading-normal text-white-dark">Enter your email and new
                                password
                                to reset your password</p>
                        </div>
                        <form method="POST" action="{{ route('password.store') }}" class="space-y-5 dark:text-white">
                            @csrf
